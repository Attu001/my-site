...
import MiddelComponent from '../components/MiddelComponent'
...
export const Home = () => {
    ...
    return (
        <>
            ...
            <div className='bg-gradient-to-br from-blue-900 via-purple-900 to-pink-800 w-screen h-screen flex-col justify-center items-center p-4 relative overflow-auto hide-scrollbar  '>
                ...
                <div className='sm:flex items-center justify-center  gap-6 mt-30 lg:mt-40  py-6 z-20 relative '>
                ...
                <div className='flex items-center justify-center  gap-6   py-6 z-20  relative'>
                    <MiddelComponent/>
                </div>
                <div className='flex items-center justify-center  gap-6 w-screen  py-6 z-20  relative'>
                    <ThirdComponent/>
                </div>
